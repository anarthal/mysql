...
BOOST_MYSQL_NETWORK_TEST(ok_no_params, network_fixture, network_gen)
{
    this->connect();
...
BOOST_MYSQL_NETWORK_TEST(ok_with_params, network_fixture, network_gen)
{
    this->connect();
    auto stmt = sample.net->prepare_statement(this->conn,
...
BOOST_MYSQL_NETWORK_TEST(invalid_statement, network_fixture, network_gen)
{
    this->connect();
    auto stmt = sample.net->prepare_statement(this->conn,
